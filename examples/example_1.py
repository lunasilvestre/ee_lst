...
my_map.add_ee_layer(ex_image.select('TPW'),
                    {'min': 0, 'max': 60, 'palette': cmap1},
                    'TCWV')
my_map.add_ee_layer(ex_image.select('TPWpos'),
                    {'min': 0, 'max': 9, 'palette': cmap1},
                    'TCWVpos')
my_map.add_ee_layer(ex_image.select('FVC'),
                    {'min': 0, 'max': 1, 'palette': cmap2},
                    'FVC')
my_map.add_ee_layer(ex_image.select('EM'),
                    {'min': 0.9, 'max': 1.0, 'palette': cmap1},
                    'Emissivity')
my_map.add_ee_layer(ex_image.select('B10'),
                    {'min': 290, 'max': 320, 'palette': cmap1},
                    'TIR BT')
my_map.add_ee_layer(ex_image.select('LST'),
                    {'min': 290, 'max': 320, 'palette': cmap1},
                    'LST')
my_map.add_ee_layer(ex_image.multiply(0.0000275).add(-0.2),
